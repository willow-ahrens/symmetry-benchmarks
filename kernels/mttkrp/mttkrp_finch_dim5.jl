...
function mttkrp_finch_opt_dim5(C, A, B)
    ...
    time_1 = @belapsed mttkrp_dim5_finch_opt_helper_base($_A_nondiag, $_B_T, $_C_T_nondiag)
    time_2 = @belapsed mttkrp_dim5_finch_opt_helper_edge($_A_diag, $_B_T, $_C_T_diag, $lookup)
