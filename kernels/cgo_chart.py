...
def all_formats_chart(results_filepath, get_matrix_name, reference, optimized, methods, colors, title, y_label, x_label, legend_labels, ordered = True, width=12):
    ...
    make_grouped_bar_chart(methods, short_mtxs, all_data, colors=colors, title=title, y_label=y_label, x_label=x_label, legend_labels=legend_labels, plot_width=width)


def make_grouped_bar_chart(labels, x_axis, data, colors = None, labeled_groups = [], title = "", y_label = "", x_label = "", bar_labels_dict={}, legend_labels=None, reference_label = "", ref_line = True, plot_width = 12):
    horizontal_scale = 1
    fontfamily = "serif"
...
all_formats_chart("ssymv/cgo_ssymv_results.json", use_suitesparse_name, "ssymv_finch_ref", "ssymv_finch_opt",
                ["ssymv_finch_opt", "ssymv_taco"],  
                {"ssymv_finch_opt": "tab:blue", "ssymv_taco": "tab:green"},
                "SSYMV Performance",
                "Speedup",
                "Matrix Name",
