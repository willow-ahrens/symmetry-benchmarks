...
int main(int argc, char *argv[]) {
  ...
  cpd_opts[SPLATT_OPTION_NTHREADS] = (argv[2][0] == 'p') ? 12 : 1;
  ...
  const int mode = 0;
  BENCH_REPEAT(splatt_mttkrp(mode, nfactors, tt, factored.factors, factored.factors[mode], cpd_opts);, NUM_TRIALS, results);
